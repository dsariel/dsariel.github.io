...
description: I was running OpenStack Tempest tests in my OpenShift cluster when I hit a problem. The pod tempest-tests-tempest-workflow-step-00-multi-thread-testing failed during image import. The issue was with a 997MB qcow2 image that would not import properly. Here's how I solved this step by step.
...
# Debugging OpenStack Tempest Pods in OpenShift Series: Failure to Import a 997MB qcow2 Image
